    ...
    switch (this.activeSection) {
            ...
            <div class="help-timeline">
              ...
              <div class="timeline-step">
                ...
                <div class="step-content">
                  ...
                  <p>Определите, где находится цена ETH относительно **Gamma Flip**.
      ...
      case 'gamma':
        html = `
          ${this.renderModuleSection(
            ...
            'Дилеры обязаны динамически хеджировать свой опционный портфель на спотовом/фьючерсном рынках. Их сделки создают мощные барьеры поддержки/сопротивления и влияют на волатильность цены ETH.',
          ...
          <div class="help-rich-content" style="margin-top: 20px;">
            <div class="help-combo-box">
              ...
              <p class="combo-desc"><strong>Результат:</strong> Полное подавление волатильности. Цена ETH намертво зажимается в узком диапазоне вблизи страйка с крупной концентрацией гаммы. Торговля на пробой строго запрещена, работаем только лимитными ордерами внутрь диапазона.</p>
            </div>
          </div>
        `;
        break;
        ...
        html = `
          ${this.renderModuleSection(
            ...
            [
              ...
              { title: 'EXPANSION (Экспансия)', desc: 'Быстрое расширение IV. Опционы дорожают, ценовые колебания ETH растут.' },
              { title: 'PANIC (Паника)', desc: 'Бэквордация структуры. Краткосрочный стресс. Высокий риск обвала цены ETH.' }
            ],
            'Ошибочно считать, что высокая волатильность (IV) всегда означает падение цены ETH. IV растет как при сильных обвалах, так и при взрывных шорт-сквизах вверх. Волатильность указывает на **скорость изменения цены**, а не на ее конечное направление.'
          )}
          ...
          <div class="help-rich-content" style="margin-top: 20px;">
            <div class="help-combo-box">
              ...
              <p class="combo-desc"><strong>Результат:</strong> Экстремальный риск шорт-сквиза или лонг-ликвидаций. Любое небольшое движение цены ETH заставляет дилеров лавинообразно совершать сделки в направлении движения для хеджирования короткой гаммы, разгоняя цену еще сильнее.</p>
            </div>
          </div>
        `;
        break;
      ...
      case 'liquidity_flow':
        html = this.renderModuleSection(
          ...
          'Ликвидность и объемы сделок — это топливо для любого движения цены ETH. flow-анализ позволяет заглянуть внутрь торговой активности и понять истинную агрессивность покупателей и продавцов.',
      ...
      case 'scenarios':
        html = this.renderModuleSection(
          ...
          'Вероятностное моделирование будущей траектории цены ETH на основе распределения рисков сквиза и прорыва опционных стен.',
          ...
          [
            { title: 'PINNED_TO_STRIKE', desc: 'Сценарий низковолатильного удержания цены ETH около ключевого страйка.' },
            { title: 'VOLATILE_RANGE', desc: 'Размашистые колебания цены ETH строго в пределах границ Call Wall и Put Wall.' },
            ...
            <table class="help-glossary-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Волатильность опционов со страйком, равным текущей спотовой цене ETH.</td>
                ...
                <tr>
                  ...
                  <td>Удерживает цену ETH в узком флэте перед экспирацией, сглаживая колебания.</td>
                </tr>
                <tr>
