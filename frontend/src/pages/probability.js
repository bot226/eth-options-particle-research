      ...
      <div class="probability-page-layout panel">
        ...
        <div class="panel-body relative" style="min-height: 400px; display: flex; flex-direction: column;">
          ...
          <div class="prob-disclaimer">
            * График PDF (Probability Density Function) показывает распределение вероятностей будущей цены BTC на основе опционов с ближайшим сроком экспирации. Разрыв между текущей ценой и пиком распределения сигнализирует о перекосе рыночных ожиданий (Skewed Risk).
          </div>
        </div>
      </div>
    `;
